...
const translations = {
  ...
  th: {
    ...
    about: {
      ...
      company: "ของเรา",
      companyText:
        "ตั้งแต่ปี 1985 คุณวิทยา สอดแนม ได้ก่อตั้ง W.A.A. Co., Ltd. ด้วยความเชี่ยวชาญด้านเครื่องจักรและการคัดเลือกสินค้า ทำให้บริษัทได้รับความไว้วางใจจากลูกค้าในหลายอุตสาหกรรม โดยเฉพาะอุตสาหกรรมชิ้นส่วนยานยนต์และการผลิตแม่พิมพ์",
      companyText2:
