        ...
        <div className="relative max-w-[1100px] mx-auto px-6 py-12">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 mb-16">
            ...
            <div className="flex-1 flex flex-col gap-3">
              <h2 className="font-sarabun text-[#B30B0F] text-3xl md:text-4xl font-bold">COFA</h2>
              <p className="font-sarabun text-[14px] text-[#1e1e1e] leading-snug max-w-[340px]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            {/* Content — left */}
            <div className="flex-1 flex flex-col gap-3 items-end text-right sm:order-1">
              <h2 className="font-sarabun text-[#B30B0F] text-3xl md:text-4xl font-bold">DL2</h2>
              <p className="font-sarabun text-[14px] text-[#1e1e1e] leading-snug max-w-[340px]">
            ...
            <div className="flex-1 flex items-center justify-center gap-4 sm:order-2">
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/76a1352e2bf60bff0801ff3604dce47e3428c16f?width=378"
                alt="DL2 Tool 1"
